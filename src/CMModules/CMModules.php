<?php
    /**
    * A model for managing CrZ modules.
    *
    * @package CrZCore
    */
...
* Properties
*/
  private $crzCoreModules = array('CrzC', 'CDatabase', 'CRequest', 'CViewContainer', 'CSession', 'CObject');
  private $crzCMFModules = array('CForm', 'CCPage', 'CCBlog', 'CMUser', 'CCUser', 'CMContent', 'CCContent', 'CFormUserLogin', 'CFormUserProfile', 'CFormUserCreate', 'CFormContent', 'CHTMLPurifier');
      ...
      private function GetDetailsOfModule($module) {
        ...
        if(class_exists($module)) {
          ...
          $details['isCrZCore']   = in_array($rc->name, $this->crzCoreModules);
          $details['isCrZCMF']    = in_array($rc->name, $this->crzCMFModules);
